...
def bt_convert():
    ...
    system = (
        ...
        "17. CRITICAL - Entry must be a TRUE CROSSOVER using PREVIOUS close vs CURRENT close, exactly matching "
        "TradingView ta.crossover(). "
        "For breakout ABOVE level L: long_cond = (self.data.Close[-2] < L) and (self.data.Close[-1] >= L). "
